...
export const registerUser = (req) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post(`${API_URL}/auth/sign-up`, req.userData);
...
export const loginUser = (req) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post(`${API_URL}/auth/sign-in`, req.userData);
...
export const addToFavorite = ({ restaurantId, jwt }) => async (dispatch) => {
    ...
    try {
        ...
        console.log("added to favorite success", data);
    } catch (error) {
        console.log("error", error);
